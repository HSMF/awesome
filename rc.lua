...
local function dump_pretty(obj, indent)
...
-- local theme_path = "/home/hyde/.config/awesome/default/theme.lua"
-- naughty.notify({ title = "theme path", text = theme_path, timeout = 0 })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "e", function()
        naughty.notify({ title = "test", text = "this is a test" })
    end),
    awful.key({ modkey, "Shift" }, "e", function()
        naughty.notify({
            title = "test",
            text = "this is a critical test",
            preset = naughty.config.presets.critical,
        })
    end),
